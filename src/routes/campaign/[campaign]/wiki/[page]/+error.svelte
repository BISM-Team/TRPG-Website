...
<div id="content" class="text-center p-2">
  {#if actualStatus === 200}
    <span></span>
  {:else if actualStatus === 404}
    <h1 class="h1 w3-section w3-padding">Page not yet created</h1>
  ...
  {:else if actualStatus === 403}
    <h1 class="h1 w3-section w3-padding">You are not allowed to view this page!</h1>
    <button {disabled} class="btn-primary" type="submit">Yes</button>
